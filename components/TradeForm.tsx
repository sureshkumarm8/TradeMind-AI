...
import { Save, X, AlertTriangle, CheckCircle2, ExternalLink, Clock, Target, Calculator } from 'lucide-react';
...
const TradeForm: React.FC<TradeFormProps> = ({ onSave, onCancel, initialData }) => {
  ...
  return (
    <div className="bg-slate-800 p-4 md:p-6 rounded-xl border border-slate-700 shadow-xl max-w-5xl mx-auto">
      <div className="flex justify-between items-center mb-6 border-b border-slate-700 pb-4">
        <h2 className="text-xl font-bold text-white flex items-center">
          {initialData ? 'Edit Trade Log' : 'Log Nifty Scalp Trade'}
        </h2>
        <div className="flex space-x-2">
            <a href="https://web.sensibull.com/open-interest/oi-vs-strike?tradingsymbol=NIFTY" target="_blank" rel="noopener noreferrer" className="flex items-center text-xs bg-orange-600/20 text-orange-400 border border-orange-500/30 px-3 py-1.5 rounded-lg hover:bg-orange-600/40 transition">
               <ExternalLink size={12} className="mr-1"/> Sensibull OI
            </a>
            <a href="https://kite.zerodha.com/markets/ext/chart/web/tvc/INDICES/NIFTY%2050/256265" target="_blank" rel="noopener noreferrer" className="flex items-center text-xs bg-blue-600/20 text-blue-400 border border-blue-500/30 px-3 py-1.5 rounded-lg hover:bg-blue-600/40 transition">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
           <div className="col-span-2 md:col-span-1">
            <label className="block text-xs font-medium text-slate-400 mb-1">Opening</label>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <input 
              ...
              className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-white outline-none focus:border-blue-500 transition"
          ...
          <div>
            ...
            <select name="direction" value={formData.direction} onChange={handleChange}
              className={`w-full border rounded-lg px-3 py-2 text-white outline-none font-semibold ${formData.direction === TradeDirection.LONG ? 'bg-blue-900/40 border-blue-600' : 'bg-amber-900/40 border-amber-600'}`}
            >
        ...
        <div className="bg-indigo-900/20 p-4 rounded-lg border border-indigo-500/30">
            <h3 className="text-xs font-bold text-indigo-400 uppercase tracking-wider mb-3 flex items-center">
                <Target size={14} className="mr-2"/> My System Checklist (Nifty 30-Pt Scalp)
            </h3>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                 <div className="relative">
                    <label className="block text-xs font-medium text-slate-400 mb-1">Entry Time</label>
                    <input 
                 ...
                 <div className="relative">
                    <label className="block text-xs font-medium text-slate-400 mb-1">Exit Time</label>
                    <input 
                 ...
                 <div className="relative">
                    <label className="block text-xs font-medium text-slate-400 mb-1">Duration (Auto)</label>
                    <div className="relative">
                        <input 
                            type="number" name="tradeDurationMins" readOnly
                            className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-3 py-2 text-slate-400 outline-none"
                            placeholder="Mins"
                 ...
                 <div className="relative">
                    <label className="block text-xs font-medium text-slate-400 mb-1">Spot Pts Captured</label>
                     <div className="relative">
                      <input 
                          type="number" name="spotPointsCaptured"
                          className={`w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-white outline-none focus:border-indigo-500 ${formData.spotPointsCaptured && formData.spotPointsCaptured >= 30 ? 'text-emerald-400 border-emerald-500/50' : ''}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <label className="flex items-center space-x-2 bg-slate-900/60 p-2 rounded border border-slate-700 cursor-pointer hover:border-indigo-500 transition">
                    ...
                    />
                    <span className="text-xs text-slate-300">Analyzed Pre-Market</span>
                </label>
                <label className="flex items-center space-x-2 bg-slate-900/60 p-2 rounded border border-slate-700 cursor-pointer hover:border-indigo-500 transition">
                    <input type="checkbox" name="waitedForOpen" 
                        ...
                        className="w-4 h-4 text-indigo-500 rounded focus:ring-indigo-500 bg-slate-800"
                    />
                    <span className="text-xs text-slate-300">Waited 5-15m Open</span>
                </label>
                 <label className="flex items-center space-x-2 bg-slate-900/60 p-2 rounded border border-slate-700 cursor-pointer hover:border-indigo-500 transition">
                    <input type="checkbox" name="checkedSensibullOI" 
                        ...
                        className="w-4 h-4 text-indigo-500 rounded focus:ring-indigo-500 bg-slate-800"
                    />
                    <span className="text-xs text-slate-300">Checked Sensibull OI</span>
                </label>
                 <label className="flex items-center space-x-2 bg-slate-900/60 p-2 rounded border border-slate-700 cursor-pointer hover:border-indigo-500 transition">
                    <input type="checkbox" name="exitTimeLimit" 
                        ...
                        className="w-4 h-4 text-indigo-500 rounded focus:ring-indigo-500 bg-slate-800"
                    />
                    <span className="text-xs text-slate-300">15-30m Checkpoint</span>
                </label>
            </div>
        </div>
        ...
        <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-800">
           <h3 className="text-xs font-bold text-slate-500 uppercase mb-3">Trade Execution</h3>
           <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
            
            {/* Nifty Spot Inputs */}
            <div className="col-span-1 md:col-span-1 border-r border-slate-800 pr-4">
              <label className="block text-xs font-medium text-emerald-400 mb-1">Nifty Spot Entry</label>
              <input 
                type="number" name="niftyEntryPrice" step="0.05"
                className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-white outline-none font-mono text-sm"
                placeholder="21500.50"
                value={formData.niftyEntryPrice || ''} onChange={handleChange}
              />
            </div>
            <div className="col-span-1 md:col-span-1 border-r border-slate-800 pr-4">
              <label className="block text-xs font-medium text-emerald-400 mb-1">Nifty Spot Exit</label>
              <input 
            ...
            <div className="col-span-1 md:col-span-1">
              <label className="block text-xs font-medium text-slate-400 mb-1">Avg Entry (₹)</label>
              <input 
             ...
             <div className="col-span-1 md:col-span-1">
              <label className="block text-xs font-medium text-slate-400 mb-1">Avg Exit (₹)</label>
              <input 
                type="number" name="exitPrice" step="0.05"
                disabled={formData.outcome === TradeOutcome.OPEN}
                className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-white outline-none font-mono disabled:opacity-50"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           <div>
             <label className="block text-xs font-medium text-slate-400 mb-1">Setup / Reason</label>
             <textarea 
                  name="entryReason" rows={3}
                  className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-white outline-none text-sm"
             ...
             <div className="mt-4">
               <label className="block text-xs font-medium text-slate-400 mb-2 flex items-center">
               ...
               <div className="flex flex-wrap gap-2">
                 {COMMON_CONFLUENCES.map(item => (
                   <button
                     ...
                     className={`text-xs px-2 py-1 rounded border transition ${formData.confluences?.includes(item) ? 'bg-emerald-500/20 border-emerald-500 text-emerald-400' : 'bg-slate-900 border-slate-700 text-slate-400 hover:border-slate-500'}`}
                   >
                     {item}
                   </button>
                 ))}
           ...
           <div>
              <label className="block text-xs font-medium text-slate-400 mb-1">Market Context</label>
              <textarea 
                name="marketContext" rows={3}
                className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-white outline-none text-sm mb-4"
               ...
               <div className="flex flex-wrap gap-2">
                 {COMMON_MISTAKES.map(item => (
                   <button
                     ...
                     className={`text-xs px-2 py-1 rounded border transition ${formData.mistakes?.includes(item) ? 'bg-red-500/20 border-red-500 text-red-400' : 'bg-slate-900 border-slate-700 text-slate-400 hover:border-slate-500'}`}
                   >
                     {item}
                   </button>
                 ))}
        ...
        <div className="flex justify-end space-x-4 pt-4 border-t border-slate-700">
          <button type="button" onClick={onCancel} className="px-6 py-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 transition">
            Cancel
          </button>
          <button type="submit" className="flex items-center px-8 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-bold transition shadow-lg shadow-indigo-900/50">
